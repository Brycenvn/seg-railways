...
def train():
    ...
    with Live("results/train") as live:
        ...
        live.log_artifact(
            ...
            type="model",
            name="railway-segmentation",
            desc="This is a Computer Vision (CV) model that's segmenting out railways from camera images.",
            labels=["cv", "segmentation", "camera-images", params.train.arch],
        )
